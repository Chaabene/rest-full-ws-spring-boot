...
@ApiModel(description = "user dynamic filtring bean desciption")
@JsonFilter(value = "dynamicFilter")
public class UserBeanDynamicFiltring {
	...
	public UserBeanDynamicFiltring(Integer id, String userName, Date birthDay) {
		super();
		this.id = id;
